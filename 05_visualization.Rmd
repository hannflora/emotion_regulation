...
# multipanel figure
multipanel_figure_EN <- state_rumi_plot + mean_state_rumi_plot + trait_rumi_plot
multipanel_figure_EN
```
...
```{r fig.height=4, fig.width=11}
# state rumination
state_rumi_plot_HU <- dat_model_visu %>% 
  ggplot(aes(x = rumination_centered, y = NA_sum)) +
  geom_jitter(color = "black", alpha = 0.05, size = 2) +
  geom_smooth(method = "lm",
              size = 2.5,
...
# mean state rumination
mean_state_rumi_plot_HU <- dat_model_visu %>% 
  ggplot(aes(x = mean_state_rumi_grand_centered, y = NA_sum)) +
  geom_jitter(color = "black", alpha = 0.05, size = 2) +
  geom_smooth(method = "lm",
              size = 2.5,
...
# trait rumination
trait_rumi_plot_HU <- dat_model_visu %>% 
  ggplot(aes(x = trait_rumination, y = NA_sum)) +
  geom_jitter(color = "black", alpha = 0.05, size = 2) +
  geom_smooth(method = "lm",
              size = 2.5,
...
# multipanel figure
multipanel_figure_HU <- state_rumi_plot_HU + mean_state_rumi_plot_HU + trait_rumi_plot_HU
multipanel_figure_HU
```
